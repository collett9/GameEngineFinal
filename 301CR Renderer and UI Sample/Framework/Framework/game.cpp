...
//setting up renderer, physics as well as ui's, loading required assets
...
//inserting all gameobject positiions into the physics system vectors for use later
...
// event handler to handle every time of event currently within the game
void game::eventHandler()
{
	...
	//removing  events from the queue when they have no subsystems left that are invovlved
	for (int i = 0; i < gameEventsVector.size(); i++)
	{
...
// handles all input from the game
...
//adding another player character for multiplayer.
